...
distance_of_markers = 150

# (5)Organize detection results
detected_obj = list() #Storage destination of detection result
tr_x = lambda x : x * distance_of_markers / 500 #X-axis image coordinates → real coordinates
tr_y = lambda y : y * distance_of_markers / 500 #Y axis 〃
